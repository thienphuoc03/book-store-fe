            ...
            <div class="px-6">
              ...
              <div class="text-center mt-12">
                ...
                <div class="mb-2 text-blueGray-600 mt-10">
                  <i
                    class="fa-solid fa-envelope mr-2 text-lg text-blueGray-400"></i>
                  {{ userInfo.email }}
                </div>
                <div class="mb-2 text-blueGray-600">
                  <i
                    class="fa-solid fa-phone mr-2 text-lg text-blueGray-400"></i>
...
<script>
import Navbar from '@/views/admin/components/Navbars/AuthNavbar.vue';
import FooterComponent from '@/views/admin/components/Footers/TheFooter.vue';
